...
public class BridgeWebView extends WebView implements WebViewJavascriptBridge {
   ...
   public void setPageLoadFinshListener(BridgeWebViewClient.PageLoadFinshListener pageLoadFinshListener){
		bridgeWebViewClient.setPageLoadFinshListener(pageLoadFinshListener);
   }
    /**
