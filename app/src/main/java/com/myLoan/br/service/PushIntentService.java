...
import com.myLoan.br.activity.LoginActivity;
...
public class PushIntentService extends GTIntentService {
    ...
    public void onReceiveServicePid(Context context, int pid) {
        DebugLog.d(TAG, "onReceiveServicePid -> " + pid);
    }
    ...
    public void onReceiveMessageData(Context context, GTTransmitMessage msg) {
        ...
        DebugLog.d(TAG, "call sendFeedbackMessage = " + (result ? "success" : "failed"));

        DebugLog.d(TAG, "onReceiveMessageData -> " + "appid = " + appid + "\ntaskid = " + taskid + "\nmessageid = " + messageid + "\npkg = " + pkg
                + "\ncid = " + cid);
        ...
        if (payload == null) {
            ...
            DebugLog.d(TAG, "receiver payload = " + data);
    ...
    public void onReceiveOnlineState(Context context, boolean online) {
        DebugLog.d(TAG, "onReceiveOnlineState -> " + (online ? "online" : "offline"));
    }

    @Override
    public void onReceiveCommandResult(Context context, GTCmdMessage cmdMessage) {
        DebugLog.d(TAG, "onReceiveCommandResult -> " + cmdMessage);
    ...
    public void onNotificationMessageArrived(Context context, GTNotificationMessage message) {
        DebugLog.d(TAG, "onNotificationMessageArrived -> " + "appid = " + message.getAppid() + "\ntaskid = " + message.getTaskId() + "\nmessageid = "
    ...
    public void onNotificationMessageClicked(Context context, GTNotificationMessage message) {
        DebugLog.d(TAG, "onNotificationMessageClicked -> " + "appid = " + message.getAppid() + "\ntaskid = " + message.getTaskId() + "\nmessageid = "
                + message.getMessageId() + "\npkg = " + message.getPkgName() + "\ncid = " + message.getClientId() + "\ntitle = "
                + message.getTitle() + "\ncontent = " + message.getContent());
        if (!(LoginContext.getLoginContext().getState() instanceof LogoutState)) {
            Intent intent = new Intent(context, WebViewActivity.class);
            intent.putExtra("urlPath", Constant.WebPath.MAIN_INFORMATION);
    ...
    private void setTagResult(SetTagCmdMessage setTagCmdMsg) {
        ...
        DebugLog.d(TAG, "settag result sn = " + sn + ", code = " + code + ", text = " + getResources().getString(text));
    }
    ...
    private void bindAliasResult(BindAliasCmdMessage bindAliasCmdMessage) {
        ...
        DebugLog.d(TAG, "bindAlias result sn = " + sn + ", code = " + code + ", text = " + getResources().getString(text));
    ...
    private void unbindAliasResult(UnBindAliasCmdMessage unBindAliasCmdMessage) {
        ...
        DebugLog.d(TAG, "unbindAlias result sn = " + sn + ", code = " + code + ", text = " + getResources().getString(text));
    ...
    private void feedbackResult(FeedbackCmdMessage feedbackCmdMsg) {
        ...
        DebugLog.d(TAG, "onReceiveCommandResult -> " + "appid = " + appid + "\ntaskid = " + taskid + "\nactionid = " + actionid + "\nresult = " + result
                + "\ncid = " + cid + "\ntimestamp = " + timestamp);
    }
    ...
    private void sendMessage(String data, int what) {
        ...
        msg.what = what;
        msg.obj = data;
        DebugLog.e("wang", "===" + data);
        //   DemoApplication.sendMessage(msg);
        handler.obtainMessage(msg.what, msg.obj);
    }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 0:
                    ...
                    intent.setAction("com.panshi.hujin2.cashLoan.news");
                    intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
